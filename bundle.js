...
var DrumMachine = function (_React$Component) {
  ...
  function DrumMachine(props) {
    ...
    _this.instruments = [new Audio('https://raw.githubusercontent.com/n1k0/tinysynth/master/public/audio/kick-classic.wav'), new Audio('https://raw.githubusercontent.com/n1k0/tinysynth/master/public/audio/snare-block.wav'), new Audio('https://raw.githubusercontent.com/n1k0/tinysynth/master/public/audio/hihat-digital.wav'), new Audio('https://raw.githubusercontent.com/n1k0/tinysynth/master/public/audio/openhat-808.wav'), new Audio('https://raw.githubusercontent.com/n1k0/tinysynth/master/public/audio/tom-acoustic01.wav'), new Audio('https://raw.githubusercontent.com/n1k0/tinysynth/master/public/audio/tom-acoustic02.wav')];

    _this.state = {
      tapped: [[false, false, false, false, false, false, false, false], [false, false, false, false, false, false, false, false], [false, false, false, false, false, false, false, false]],
      instruments: [_this.instruments[0], _this.instruments[1], _this.instruments[2]],
    ...
    _this.clearRow = _this.clearRow.bind(_this);
  ...
  _createClass(DrumMachine, [{
    key: 'songLoop',
    value: function songLoop() {
      var drumMachine = this;
      this.timeout = setTimeout(function () {
        var column = (drumMachine.state.currentColumn + 1) % drumMachine.columnCount;
        drumMachine.state.tapped.forEach(function (row, i) {
          if (row[column]) {
            var pad = drumMachine.state.instruments[i];
            pad.pause();
            pad.currentTime = 0;
            pad.play();
          }
    ...
    key: 'togglePlay',
    value: function togglePlay(isPlaying) {
      if (isPlaying) {
    ...
    value: function addRow() {
      var rows = this.state.tapped.slice();
      var instr = this.state.instruments.slice();
    ...
    key: 'clearRow',
    value: function clearRow(rowIndex) {
      var rows = this.state.tapped.slice();
    ...
    value: function changeInstrument(row, instrument) {
      var instruments = this.state.instruments.slice();
      var names = this.state.names.slice();
      var instrToReplace = void 0;
      var nameToReplace = void 0;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this3.togglePlay(_this3.state.isPlaying);
              } },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', {
              ...
              onChange: function onChange(e) {
                _this3.setState({ bpm: e.target.value });
              }
            }),
            _react2.default.createElement(
              'p',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            [0, 1, 2, 3, 4, 5, 6, 7].map(function (num) {
              return _react2.default.createElement('div', { className: 'column' + (_this3.state.currentColumn === num ? ' active' : '') });
            })
          ),
          this.state.tapped.map(function (row, rowIndex) {
            // Return row of pads + tools
            return _react2.default.createElement(
              'div',
              { className: 'row', id: rowIndex },
              _react2.default.createElement(
                'select',
                { value: _this3.state.names[rowIndex], onChange: function onChange(e) {
                    return _this3.changeInstrument(e.target.parentNode.id, e.target.value);
                  } },
                _react2.default.createElement(
                  'option',
                  { value: 'kick' },
              ...
              row.map(function (pad, padIndex) {
                return _this3.renderPad(rowIndex, padIndex);
              }),
              _react2.default.createElement(
                'button',
                { className: 'clear', onClick: function onClick(e) {
                    _this3.clearRow(e.target.parentNode.id);
                  } },
                'clear'
              ),
              _react2.default.createElement(
                ...
                { className: 'delete', onClick: function onClick(e) {
                    _this3.deleteRow(e.target.parentNode.id);
                  } },
                'X'
              )
            );
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://n1k0.github.io/tinysynth/' },
              '@n1k0'
            )
          ),
          _react2.default.createElement(
...
_reactDom2.default.render(_react2.default.createElement(DrumMachine, null), document.getElementById('app'));
